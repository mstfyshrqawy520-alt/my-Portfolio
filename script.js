document.addEventListener('DOMContentLoaded', () => {
  ...
  const domainData = {
    ml: { title: 'Machine <span class="accent-text">Learning</span>', subtitle: 'Predictive modeling and classification.', link: 'machine-learning.html', projects: [
      { title: 'Breast Cancer Classification', desc: 'High-precision diagnostic system.', tags: ['Scikit-learn', 'FastAPI'], repo: 'https://github.com/mstfyshrqawy520-alt/breast-cancer-classification-ml', id: 'breastcancer' },
      { title: 'Glioma Tumor Grading', desc: 'Clinical risk assessment tool.', tags: ['Random Forest', 'Medical AI'], repo: 'https://github.com/mstfyshrqawy520-alt/glioma-tumor-grading-ml', id: 'glioma' },
      { title: 'Credit Risk Analysis', desc: 'Financial risk management system.', tags: ['XGBoost', 'Finance'], repo: 'https://github.com/mstfyshrqawy520-alt/credit-customers-risk-analysis', id: 'creditrisk' }
    ]},
    dl: { title: 'Deep <span class="accent-text">Learning</span>', subtitle: 'Neural networks and architectures.', link: 'deep-learning.html', projects: [
      { title: 'House Rent Prediction (ANN)', desc: 'TensorFlow regression model.', tags: ['Keras', 'ANN'], repo: 'https://github.com/mstfyshrqawy520-alt/House-Rent-Price-Prediction-ANN', id: 'houserent' },
      { title: 'Grape Leaves Classification', desc: 'Agricultural disease identification.', tags: ['ResNet50', 'CV'], repo: 'https://github.com/mstfyshrqawy520-alt/grape-leaves-classification', id: 'grapeleaf' }
    ]},
    genai: { title: 'Generative <span class="accent-text">AI</span>', subtitle: 'LLMs and synthetic systems.', link: 'generative-ai.html', projects: [
      { title: 'LocalGPT', desc: 'Private document intelligence platform.', tags: ['Ollama', 'RAG'], repo: 'https://github.com/mstfyshrqawy520-alt/LocalGPT', id: 'localgpt' }
    ]},
    nlp: { title: 'NLP & <span class="accent-text">Audio</span>', subtitle: 'Text analysis and understanding.', link: 'nlp.html', projects: [
      { title: 'Fake News Detection', desc: 'NLP authenticity verifier.', tags: ['NLTK', 'NLP'], repo: 'https://github.com/mstfyshrqawy520-alt/fake-news-detection-nlp', id: 'fakenews' }
    ]}
  };

  domainCards.forEach(card => {
    card.addEventListener('click', () => {
      const data = domainData[card.dataset.domain];
      if (data) {
          ...
          projectCard.innerHTML = `
            <div class="project-info">
              ...
              <div style="display: flex; gap: 1rem;">
                <a href="${p.repo}" target="_blank" class="btn btn-outline">Repo</a>
                <button class="btn btn-outline project-more-btn" data-project="${p.id}">Details</button>
              </div>
            </div>
          `;
        ...
        setTimeout(() => domainContainer.scrollIntoView({ behavior: 'smooth', block: 'start' }), 100);
      }
    });
  });
});